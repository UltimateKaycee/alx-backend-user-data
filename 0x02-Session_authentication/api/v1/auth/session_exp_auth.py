#!/usr/bin/env python3
"""
Module to define SessionExpAuth class
"""
import os
...
class SessionExpAuth(SessionAuth):
    """
    Class definition for SessionExpAuth that adds an
    ...
    def create_session(self, user_id=None):
        """
        Function to create a Session ID for a user_id
        Args:
            user_id (str): user id
        """
    ...
    def user_id_for_session_id(self, session_id=None):
        """
        Function to returns a user ID based on a session ID
        Args:
